...
static inline uint32_t get_unaligned32(const void *ptr) {
    return *(unaligned_uint32_t *)ptr;
}

static inline void put_unaligned32(const void *ptr, uint32_t value) {
    *(unaligned_uint32_t *)ptr = value;
}

#define MBEDTLS_GET_UINT32_LE(ptr, offset) get_unaligned32((ptr) + (offset))
#define MBEDTLS_PUT_UINT32_LE(ptr, offset, data) put_unaligned32((ptr) + (offset), data)
