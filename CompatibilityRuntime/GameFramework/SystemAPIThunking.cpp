...
/*
 * Signal handling should not be ever *actually* needed.
 */
#if 0
void plat_rt_sigreturn() {
    panic("__rt_sigreturn called\n");
}
#endif
 ...
 */
#if 0
    { "__rt_sigreturn", &thunkX86<plat_rt_sigreturn> },
  ...
  //  { "fmodf", &thunkX86<fmodf> },
    ...
    { "sysconf", &thunkX86<android_sysconf> },
