...
BionicSetErrnoType arm_bionic_set_errno;
...
void bindBionicCallouts(const Image &bionic) {
    ...
    arm_bionic_set_errno = reinterpret_cast<BionicSetErrnoType>(bionic.getSymbolChecked("__compatibility_runtime_set_errno"));
